        ...
        <Layout>
            <div className="py-10">
                <div
                    ...
                    <div className="left">
                        <img
                            className=" w-40 h-40  object-cover rounded-full border-2 border-yellow-600 p-1"
                    ...
                    <div className="right">
                        ...
                        <h2
                            ...
                            FrontEnd Dev and Movie Enthusiast
                        </h2>
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">CalvinLawrence98@gmail.com
                        </h2>
                        {/* Get Total Blog */}
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
